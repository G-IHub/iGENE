...
export const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-6 left-0 right-0 z-50 mx-auto max-w-[95%] lg:max-w-7xl">
      <div className="flex h-[72px] items-center justify-between rounded-2xl bg-white lg:mx-10 px-1 py-2 shadow-[0_4px_20px_rgba(0,0,0,0.05)] md:px-8">
        ...
        <a href="#" className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full border border-purple-100 p-0.5 flex items-center justify-center overflow-hidden shrink-0">
            <img src={logoImg} className="w-full h-full object-cover rounded-full" alt="iGENE Logo" />
          </div>
        ...
        <div className="hidden items-center gap-8 md:flex">
          <a href="https://www.genomaclabs.com/about" className="text-[16px] font-medium text-[#666666] transition-colors hover:text-[#972FAF]">
            About Us
          </a>
          ...
          <a href="https://www.genomaclabs.com/contact" className="text-[16px] font-medium text-[#666666] transition-colors hover:text-[#972FAF]">
            Contact US
          </a>
        </div>
